                    ...
                    <div id="about-content-me" className="text-center w-275 lg:flex lg:flex-row-reverse lg:text-left max-w-content-small md:max-w-content-medium lg:max-w-content-large">
                        ...
                        <label id="about-content-me-info" className="font-gotham-rounded-light text-light_secondary text-body-small md:text-body-large w-200.5 pr-20">
                            ...
                            Een aantal voorbeelden van projecten zijn: Husqy (een Discord Bot geschreven in Python), Nietveel.be (een website ter oriëntatie op Laravel) en Lukehendriks.net (deze website geschreven in React).
                             Ik heb hier met veel plezier aan gewerkt en sommige van deze projecten lopen nog steeds. Voor meer over deze projecten, zie {<Link className="text-light_accent hover:font-gotham-rounded-medium" to="/projecten">/Projecten</Link>}.
                            <br /><br />
                            Mocht je contact met me op willen nemen dan kan dit via: {<Link to="/contact" className="hover:text-light_accent">Mail &#x2197;</Link>}, {<a href="https://github.com/l3keboy" rel="noreferrer" target="_blank" className="hover:text-light_accent">GitHub &#x2197;</a>}, {<a href="https://twitter.com/l3keboy" rel="noreferrer" target="_blank" className="hover:text-light_accent">Twitter &#x2197;</a>} of {<a href="https://linkedin.com/in/luke-h-421515225/" rel="noreferrer" target="_blank" className="hover:text-light_accent">LinkedIn &#x2197;</a>}.              
                        </label>
                    </div>
                </div>
            </div>
