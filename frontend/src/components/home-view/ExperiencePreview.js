        ...
        <div id="experience">
            <div id="experience-content" className="bg-light_secondary text-light_primary text-center  flex flex-col items-center">
                ...
                <div id="experience-content-items">
                    <div id="experience-content-items-subtitle" className="pb-4 md:pb-6 lg:flex">
                    ...
                    <div id="experience-content-items-education" className="z-10 flex flex-col w-60 md:w-96 lg:flex-row lg:w-275 justify-center ">
                        <div id="experience-content-items-education-preview" className="z-10 w-24 md:w-48 mx-auto mt-2">
                    ...
                    <div id="experience-content-items-subtitle" className="pb-4 md:pb-6 lg:flex">
                        <label id="experience-content-items-subtitle-text" className="z-10 font-gotham-rounded-book text-center text-h3-small md:text-h3-large">Vorige werkgever</label>
                    </div>
                    <div id="experience-content-items-work" className="flex flex-col w-60 md:w-96 lg:flex-row lg:w-275 justify-center">
                        <div id="experience-content-items-work-preview" className="z-10 w-24 md:w-48 mx-auto mt-2">
