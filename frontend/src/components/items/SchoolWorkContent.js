...
const SchoolWorkContent = (props) => {
    let website_button
    if (props.link){
        website_button = <a href={props.link} rel="noreferrer" target="_blank" className="hover:font-gotham-rounded-medium text-light_accent">Website &#x2197;</a>
    } else {
        website_button = <a href className="opacity-50 text-light_accent hover:cursor-not-allowed">Website &#x2197;</a>  
    }
    return (
