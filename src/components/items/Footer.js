        ...
        <div id="footer">
                ...
                <div id="footer-top-content" className="max-w-content-small m-auto md:max-w-content-medium lg:max-w-content-large">
                    ...
                    <div id="footer-top-content-links" className="block md:flex md:justify-between">
                        <div id="footer-top-content-links-socials" className="flex justify-center pb-4 md:pb-12">
                            <div id="footer-top-content-links-socials-github" className="px-2 md:px-0 md:pr-6">
                                <a href="https://github.com/l3keboy" rel="noreferrer" target="_blank">GitHub &#x2197;</a>
                            </div> 
                            <div id="footer-top-content-links-socials-twitter" className="px-2 md:px-0 md:pr-6">
                                <a href="https://twitter.com/l3keboy" rel="noreferrer" target="_blank">Twitter &#x2197;</a>
                            </div> 
                            <div id="footer-top-content-links-socials-linkedin" className="px-2 md:px-0 md:pr-6">
                                <a href="https://linkedin.com/in/luke-h-421515225/" rel="noreferrer" target="_blank">LinkedIn &#x2197;</a>
                            </div> 
                        </div>
            ...
            <div id="footer-bottom" className="bg-light_secondary text-light_primary text-footer2-small lg:text-footer2-large">
                <div id="footer-bottom-content" className="font-gotham-rounded-medium max-w-content-small block items-center py-3 text-center m-auto h-12 md:max-w-content-medium md:flex md:py-0 md:justify-between md:m-auto lg:max-w-content-large">
                    ...
                    {/* <p id="footer-bottom-content-privacy-tos"><Link to="/privacy">Privacyverklaring</Link> &emsp;|&emsp; <Link to="/gebruiksvoorwaarden">Gebruiksvoorwaarden</Link></p> */}
                </div>
            </div>
        </div>
    )
