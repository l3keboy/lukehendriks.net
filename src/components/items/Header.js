        ...
        <div id="header" className="max-w-content-small md:max-w-content-medium lg:max-w-content-large m-auto">
            <header id="header-content" className="font-gotham-rounded-medium flex justify-between max-w-content-small md:max-w-content-medium lg:max-w-content-large m-auto">
                ...
                <nav id="header-content-nav" className="text-h4-small lg:text-h4-large my-auto">
                    <li id="header-content-nav-link" className="hidden md:inline-block pr-12"><Link to="/over-mij">Over mij</Link></li>
                    <li id="header-content-nav-link" className="hidden md:inline-block pr-12"><Link to="/ervaring">Ervaring</Link></li>
                    <button id="header-content-nav-button" onClick={()=> history.push('/projecten')} className="hidden md:inline-block border-light_accent text-body-small md:text-body-large border-2 rounded-xl px-4 py-1">Projecten</button>
                </nav>
